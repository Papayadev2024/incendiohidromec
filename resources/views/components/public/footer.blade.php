        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0">
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex justify-start items-center">
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=51946260675&text=¡Hola%20Hidromec!%20Quisiera%20recibir%20más%20detalles%20sobre%20sus%20productos%20y%20servicios%20especializados%20en%20Sistema%20Contra%20Incendios." rel="noopener"
                        class="bg-[#222A51] text-white font-helveticaBold text-text16 py-4 px-6 rounded-xl">Contáctanos
                        ahora</a>
                </div>
            </div>
        </div>
